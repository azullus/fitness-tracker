...
import { User, Users, ArrowRight, ArrowLeft, Check, Dumbbell, Heart, Flame, Target } from 'lucide-react';
import { calculateBMI, calculateDailyCalories } from '@/lib/recipe-utils';
import type { Person } from '@/lib/types';

interface OnboardingWizardProps {
  onComplete: (persons: Omit<Person, 'id' | 'created_at'>[]) => void;
  onCancel?: () => void;
          ...
          <div className="flex gap-3 mt-6">
            ...
            {step === 'review' && (
              <button
                ...
                className="flex-1 py-3 px-4 bg-green-500 text-white rounded-lg hover:bg-green-600 flex items-center justify-center gap-2"
              >
